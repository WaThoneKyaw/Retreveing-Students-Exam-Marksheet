...
public class markforep6 extends JFrame {
	private int sum=0;
	private JTextField textfield_1;
	private JLabel label_1;
	//private FlowLayout flowlayout;
	 public markforep6(ObservableList data) {
	...
	*/
	...
	JLabel label_10 = new JLabel("Industrial Engineering and Management");
	JLabel label_11 = new JLabel("Computer Aided Electrical Engineering");
	JLabel label_12 = new JLabel("Electrical Safty and Ethic");
	JLabel label_13 = new JLabel("Power System Reliability");
	...
	getContentPane().add(panel6,new BorderLayout().SOUTH);
		...
		sum+= Integer.parseInt(tf1.getText())+Integer.parseInt(tf2.getText())+Integer.parseInt(tf3.getText())
				+ Integer.parseInt(tf4.getText())+Integer.parseInt(tf5.getText());
