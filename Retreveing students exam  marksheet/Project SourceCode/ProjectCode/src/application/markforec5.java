...
public class markforec5 extends JFrame {
	private int sum=0;
	private JTextField textfield_1;
	private JLabel label_1;
	//private FlowLayout flowlayout;
	 public markforec5(ObservableList data) {
	...
	*/
	...
	panel5.add(sub);
	panel5.add(obt);		
	JLabel label_9= new JLabel("Advanced Electronics");
	JLabel label_10 = new JLabel("Digital Control System");
	JLabel label_11 = new JLabel("Digital Signal Processing");
	JLabel label_12 = new JLabel("Industrial Management");
	JLabel label_13 = new JLabel("Modern Electronic Communication System");
	JLabel label_14 = new JLabel("Microwave Engineering");
	JLabel label_15 = new JLabel("PCL Programming Methods and Techniques");
