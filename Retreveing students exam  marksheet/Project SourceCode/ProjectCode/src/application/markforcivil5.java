...
public class markforcivil5 extends JFrame {
	private int sum=0;
	private JTextField textfield_1;
	private JLabel label_1;
	//private FlowLayout flowlayout;
	 public markforcivil5(ObservableList data) {
	...
	*/
	...
	panel5.add(sub);
	panel5.add(obt);		
	JLabel label_9= new JLabel("Theory of Structures");
	JLabel label_10 = new JLabel("Design of Reinforced Concrete Structures");
	JLabel label_11 = new JLabel("Construction Engineering Management");
	JLabel label_12 = new JLabel("Design of Hydraulic Structures");
	JLabel label_13 = new JLabel("Design of Steel Structures");
	JLabel label_14 = new JLabel("Environmental Engineering");
	JLabel label_15 = new JLabel("Estamating and Specifications");
	...
	getContentPane().add(panel6,new BorderLayout().SOUTH);
		...
		+ Integer.parseInt(tf5.getText())+Integer.parseInt(tf6.getText())+Integer.parseInt(tf7.getText());
