...
public class firstectableview implements Serializable{
	...
	public SimpleStringProperty fec = new SimpleStringProperty();
	public SimpleStringProperty drawing = new SimpleStringProperty();
	
	public firstectableview(String rno,String name,String myan,String eng,String math,String chem,String phy,String fec,String drawing) {
        ...
        this.fec = new SimpleStringProperty(fec);
	...
	public StringProperty  fecProperty(){
		return fec;
	}
