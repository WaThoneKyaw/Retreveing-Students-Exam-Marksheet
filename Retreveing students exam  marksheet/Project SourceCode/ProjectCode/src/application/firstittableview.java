...
public class firstittableview implements Serializable{
	...
	public SimpleStringProperty ics = new SimpleStringProperty();
	
	public firstittableview(String rno,String name,String myan,String eng,String math,String chem,String phy,String drawing,String ics) {
        ...
        this.ics = new SimpleStringProperty(ics);  
	...
	public StringProperty  icsProperty(){
		return ics;
	}
