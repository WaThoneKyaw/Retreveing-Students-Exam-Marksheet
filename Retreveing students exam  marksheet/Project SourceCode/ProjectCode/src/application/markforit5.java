...
public class markforit5 extends JFrame {
	private int sum=0;
	private JTextField textfield_1;
	private JLabel label_1;
	//private FlowLayout flowlayout;
	 public markforit5(ObservableList data) {
	...
	*/
	...
	panel5.add(sub);
	panel5.add(obt);		
	JLabel label_9= new JLabel("Embedded Systems");
	JLabel label_10 = new JLabel("Cryptography and Network Security");
	JLabel label_11 = new JLabel("Artificial Intelligence");
	JLabel label_12 = new JLabel("Digital Image Processing");
	JLabel label_13 = new JLabel("Software Engineering");
