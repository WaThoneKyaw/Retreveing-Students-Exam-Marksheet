...
public class markforep5 extends JFrame {
	private int sum=0;
	private JTextField textfield_1;
	private JLabel label_1;
	//private FlowLayout flowlayout;
	 public markforep5(ObservableList data) {
	...
	*/
	...
	panel5.add(sub);
	panel5.add(obt);		
	JLabel label_9= new JLabel("Modern Control System");
	JLabel label_10 = new JLabel("Electrical Machine and Control");
	JLabel label_11 = new JLabel("Power System Protection");
	JLabel label_12 = new JLabel("Economic Operation of Power System");
	JLabel label_13 = new JLabel("Electromechanical Energy Conversion");
